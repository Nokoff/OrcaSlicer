...
static const FileWildcards file_wildcards_by_type[FT_SIZE] = {
    ...
    /* FT_MODEL */
    {"Supported files"sv,
     {".3mf"sv, ".stl"sv, ".oltp"sv, ".stp"sv, ".step"sv, ".svg"sv, ".amf"sv, ".obj"sv, ".glb"sv, ".gltf"sv, ".usd"sv, ".usda"sv,
      ".usdc"sv, ".usdz"sv, ".abc"sv, ".ply"sv}},
#else
    /* FT_MODEL */
...
void GUI_App::import_model(wxWindow *parent, wxArrayString& input_files) const
{
    ...
    wxFileDialog dialog(parent ? parent : GetTopWindow(),
#ifdef __APPLE__
        _L("Choose one or more files (3mf/step/stl/svg/obj/glb/gltf/amf/usd*/abc/ply):"),
#else
        _L("Choose one or more files (3mf/step/stl/svg/obj/glb/gltf/amf):"),
#endif
        from_u8(app_config->get_last_dir()), "",
